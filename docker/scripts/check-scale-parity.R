...
rust_scale_on_cpp <- RSeurat::FastSparseRowScale(cpp_norm[hvf, , drop = FALSE], TRUE, TRUE, 10, FALSE)
rust_scale_on_rust <- RSeurat::FastSparseRowScale(rust_norm[hvf, , drop = FALSE], TRUE, TRUE, 10, FALSE)
